...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("sussy Issy", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("sussy Issy", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "2";
		app.meta["company"] = "kadeengine";
		app.meta["file"] = "sussy Issy";
		app.meta["name"] = "FNF: vs Isaak";
		app.meta["packageName"] = "com.kadeengine.vsisaak";
