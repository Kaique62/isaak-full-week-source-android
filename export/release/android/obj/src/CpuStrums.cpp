...
HX_DEFINE_STACK_FRAME(_hx_pos_d72f4eec24a4e69d_137_new,"CpuStrums","new",0x3ccd0824,"CpuStrums.new","Options.hx",137,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_d72f4eec24a4e69d_143_press,"CpuStrums","press",0xff920447,"CpuStrums.press","Options.hx",143,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_d72f4eec24a4e69d_152_updateDisplay,"CpuStrums","updateDisplay",0xe7c6a3fd,"CpuStrums.updateDisplay","Options.hx",152,0x9d9a0240)

void CpuStrums_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_d72f4eec24a4e69d_137_new)
HXLINE( 138)		super::__construct();
HXLINE( 139)		this->description = desc;
            	}
...
bool CpuStrums_obj::press(){
            	HX_STACKFRAME(&_hx_pos_d72f4eec24a4e69d_143_press)
HXLINE( 144)		::flixel::FlxG_obj::save->data->__SetField(HX_("cpuStrums",52,86,8a,e0),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("cpuStrums",52,86,8a,e0),::hx::paccDynamic)) )),::hx::paccDynamic);
...
::String CpuStrums_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_d72f4eec24a4e69d_152_updateDisplay)
HXDLIN( 152)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("cpuStrums",52,86,8a,e0),::hx::paccDynamic)) )) {
HXDLIN( 152)			return HX_("Light CPU Strums",6c,fa,25,83);
            		}
            		else {
HXDLIN( 152)			return HX_("CPU Strums stay static",37,20,45,c4);
            		}
