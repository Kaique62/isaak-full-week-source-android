...
HX_LOCAL_STACK_FRAME(_hx_pos_c850dab95dbcbdf8_39_resolve,"haxe.xml._Access.AttribAccess_Impl_","resolve",0xf06df4f6,"haxe.xml._Access.AttribAccess_Impl_.resolve","D:\\modding stuff\\haxe\\std/haxe/xml/Access.hx",39,0x810d7e0d)
namespace haxe{
namespace xml{
namespace _Access{
...
::String AttribAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_c850dab95dbcbdf8_39_resolve)
