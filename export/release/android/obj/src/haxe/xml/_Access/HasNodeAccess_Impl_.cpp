...
HX_LOCAL_STACK_FRAME(_hx_pos_1cd37fa49533775a_69_resolve,"haxe.xml._Access.HasNodeAccess_Impl_","resolve",0x5a406854,"haxe.xml._Access.HasNodeAccess_Impl_.resolve","D:\\modding stuff\\haxe\\std/haxe/xml/Access.hx",69,0x810d7e0d)
namespace haxe{
namespace xml{
namespace _Access{
...
bool HasNodeAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_1cd37fa49533775a_69_resolve)
