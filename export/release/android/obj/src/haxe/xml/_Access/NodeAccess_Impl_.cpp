...
HX_LOCAL_STACK_FRAME(_hx_pos_9ce33af40f59bc48_27_resolve,"haxe.xml._Access.NodeAccess_Impl_","resolve",0xc66a9d2e,"haxe.xml._Access.NodeAccess_Impl_.resolve","D:\\modding stuff\\haxe\\std/haxe/xml/Access.hx",27,0x810d7e0d)
namespace haxe{
namespace xml{
namespace _Access{
...
bool NodeAccess_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Xml NodeAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_9ce33af40f59bc48_27_resolve)
