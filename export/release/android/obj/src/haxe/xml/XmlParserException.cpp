...
HX_DEFINE_STACK_FRAME(_hx_pos_363b8ebf30cb5abd_75_new,"haxe.xml.XmlParserException","new",0xcd6fdfea,"haxe.xml.XmlParserException.new","D:\\modding stuff\\haxe\\std/haxe/xml/Parser.hx",75,0x63496db2)
HX_LOCAL_STACK_FRAME(_hx_pos_363b8ebf30cb5abd_95_toString,"haxe.xml.XmlParserException","toString",0xed7c2ce2,"haxe.xml.XmlParserException.toString","D:\\modding stuff\\haxe\\std/haxe/xml/Parser.hx",95,0x63496db2)
namespace haxe{
namespace xml{

void XmlParserException_obj::__construct(::String message,::String xml,int position){
            	HX_STACKFRAME(&_hx_pos_363b8ebf30cb5abd_75_new)
...
::String XmlParserException_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_363b8ebf30cb5abd_95_toString)
