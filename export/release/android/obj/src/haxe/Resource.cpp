...
HX_LOCAL_STACK_FRAME(_hx_pos_dcde314d8d23b441_35_getBytes,"haxe.Resource","getBytes",0x9bc1712d,"haxe.Resource.getBytes","D:\\modding stuff\\haxe\\std/cpp/_std/haxe/Resource.hx",35,0xd143fa52)
namespace haxe{
...
bool Resource_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes Resource_obj::getBytes(::String name){
            	HX_STACKFRAME(&_hx_pos_dcde314d8d23b441_35_getBytes)
