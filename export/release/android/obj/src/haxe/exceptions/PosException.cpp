...
HX_DEFINE_STACK_FRAME(_hx_pos_57da4529b5d12378_12_new,"haxe.exceptions.PosException","new",0x9ed038cf,"haxe.exceptions.PosException.new","D:\\modding stuff\\haxe\\std/haxe/exceptions/PosException.hx",12,0x6302dc6d)
HX_LOCAL_STACK_FRAME(_hx_pos_57da4529b5d12378_25_toString,"haxe.exceptions.PosException","toString",0x179675dd,"haxe.exceptions.PosException.toString","D:\\modding stuff\\haxe\\std/haxe/exceptions/PosException.hx",25,0x6302dc6d)
namespace haxe{
namespace exceptions{

void PosException_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic pos){
            	HX_STACKFRAME(&_hx_pos_57da4529b5d12378_12_new)
...
::String PosException_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_57da4529b5d12378_25_toString)
