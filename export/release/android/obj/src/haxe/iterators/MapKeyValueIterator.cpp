...
HX_DEFINE_STACK_FRAME(_hx_pos_8d02c3d14680f00a_35_new,"haxe.iterators.MapKeyValueIterator","new",0x902a97fd,"haxe.iterators.MapKeyValueIterator.new","D:\\modding stuff\\haxe\\std/haxe/iterators/MapKeyValueIterator.hx",35,0x354b7461)
HX_LOCAL_STACK_FRAME(_hx_pos_8d02c3d14680f00a_44_hasNext,"haxe.iterators.MapKeyValueIterator","hasNext",0x6e75ff8a,"haxe.iterators.MapKeyValueIterator.hasNext","D:\\modding stuff\\haxe\\std/haxe/iterators/MapKeyValueIterator.hx",44,0x354b7461)
HX_LOCAL_STACK_FRAME(_hx_pos_8d02c3d14680f00a_50_next,"haxe.iterators.MapKeyValueIterator","next",0x951a66b6,"haxe.iterators.MapKeyValueIterator.next","D:\\modding stuff\\haxe\\std/haxe/iterators/MapKeyValueIterator.hx",50,0x354b7461)
namespace haxe{
namespace iterators{

void MapKeyValueIterator_obj::__construct(::Dynamic map){
            	HX_STACKFRAME(&_hx_pos_8d02c3d14680f00a_35_new)
...
bool MapKeyValueIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_8d02c3d14680f00a_44_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(MapKeyValueIterator_obj,hasNext,return )
 ...
 ::Dynamic MapKeyValueIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_8d02c3d14680f00a_50_next)
