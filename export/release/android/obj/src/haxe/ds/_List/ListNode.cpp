...
HX_DEFINE_STACK_FRAME(_hx_pos_f9258bb9d2d779f3_266_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","D:\\modding stuff\\haxe\\std/haxe/ds/List.hx",266,0x9bfd1a55)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_f9258bb9d2d779f3_266_new)
