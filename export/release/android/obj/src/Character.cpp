...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_580_update,"Character","update",0x0e18944e,"Character.update","Character.hx",580,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_617_dance,"Character","dance",0xde4da48e,"Character.dance","Character.hx",617,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_678_playAnim,"Character","playAnim",0xed2bd3aa,"Character.playAnim","Character.hx",678,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_709_addOffset,"Character","addOffset",0x6dc9376f,"Character.addOffset","Character.hx",709,0xf073a2d5)
...
HXLINE( 125)			goto _hx_goto_0;
            		...
            		if (  (_hx_switch_0==HX_("funkyisaac",0c,77,b5,1d)) ){
HXLINE( 518)			::String tex1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/funkyisaac",91,9b,4a,3e)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 518)			tex = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/funkyisaac",91,9b,4a,3e)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d)));
HXLINE( 519)			this->set_frames(tex);
HXLINE( 520)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Isaac Idle",fb,b2,21,38),24,null(),null(),null());
HXLINE( 521)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("Isaac Up",82,da,8b,e1),24,null(),null(),null());
HXLINE( 522)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("Isaac Right",15,6a,40,17),24,null(),null(),null());
HXLINE( 523)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("Isaac Down",49,04,dc,34),24,null(),null(),null());
HXLINE( 524)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("Isaac Left",ee,13,1e,3a),24,null(),null(),null());
HXLINE( 526)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 527)			this->addOffset(HX_("singUP",6a,52,21,b9),31,5);
HXLINE( 528)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),-22,-16);
HXLINE( 529)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),36,-13);
HXLINE( 530)			this->addOffset(HX_("singDOWN",31,2a,ad,36),-2,-34);
...
HXLINE(  50)			this->addOffset(HX_("sad",16,98,57,00),0,-21);
...
HXLINE(  58)			this->addOffset(HX_("hairBlow",b4,c9,39,c9),99,-8);
HXLINE(  59)			this->addOffset(HX_("hairFall",bd,48,d6,cb),8,-9);
HXLINE(  61)			this->addOffset(HX_("scared",20,78,2a,3c),0,-17);
...
HXLINE( 109)			goto _hx_goto_0;
            		...
            		if (  (_hx_switch_0==HX_("isaacangel",48,89,f3,c6)) ){
HXLINE( 533)			::String tex1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/IsaacAngel",cd,21,67,71)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 533)			tex = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/IsaacAngel",cd,21,67,71)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d)));
HXLINE( 534)			this->set_frames(tex);
HXLINE( 535)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("AngelIdle",55,65,fa,9f),24,null(),null(),null());
HXLINE( 536)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("AngelUp",5c,62,8f,1b),24,null(),null(),null());
HXLINE( 537)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("AngelRight",7b,c6,03,8d),24,null(),null(),null());
HXLINE( 538)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("AngelDown",a3,b6,b4,9c),24,null(),null(),null());
HXLINE( 539)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("AngelLeft",48,c6,f6,a1),24,null(),null(),null());
HXLINE( 540)			this->animation->addByPrefix(HX_("singUP-alt",86,62,b4,5f),HX_("ZAngel",07,27,2e,b2),24,false,null(),null());
HXLINE( 542)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 543)			this->addOffset(HX_("singUP",6a,52,21,b9),31,5);
HXLINE( 544)			this->addOffset(HX_("singUP-alt",86,62,b4,5f),31,800);
HXLINE( 545)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),-22,-16);
HXLINE( 546)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),36,-13);
HXLINE( 547)			this->addOffset(HX_("singDOWN",31,2a,ad,36),-2,-34);
HXLINE( 548)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 550)			this->setGraphicSize(::Std_obj::_hx_int(this->get_width()),null());
HXLINE( 532)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("isaacshifting",79,c0,81,02)) ){
HXLINE( 503)			::String tex1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/isaacshifting",14,7d,a4,d0)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 503)			tex = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/isaacshifting",14,7d,a4,d0)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d)));
HXLINE( 504)			this->set_frames(tex);
HXLINE( 505)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("ShiftingIdle",f4,cc,64,09),24,null(),null(),null());
HXLINE( 506)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("ShiftingUp",3b,54,f2,30),24,null(),null(),null());
HXLINE( 507)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("ShiftingRight",fc,09,b4,60),24,null(),null(),null());
HXLINE( 508)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("ShiftingDown",42,1e,1f,06),24,null(),null(),null());
HXLINE( 509)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("ShiftingLeft",e7,2d,61,0b),24,null(),null(),null());
HXLINE( 511)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 512)			this->addOffset(HX_("singUP",6a,52,21,b9),31,5);
HXLINE( 513)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),-22,-16);
HXLINE( 514)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),36,-13);
HXLINE( 515)			this->addOffset(HX_("singDOWN",31,2a,ad,36),-2,-34);
...
HXLINE( 142)			goto _hx_goto_0;
            		...
            		_hx_goto_0:;
HXLINE( 554)		this->dance();
HXLINE( 556)		if (( (bool)(isPlayer) )) {
HXLINE( 558)			this->set_flipX(!(this->flipX));
HXLINE( 561)			if (!(::StringTools_obj::startsWith(this->curCharacter,HX_("bf",c4,55,00,00)))) {
HXLINE( 564)				::Array< int > oldRight = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHT",0d,6f,70,ac))) )->frames;
HXLINE( 565)				( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHT",0d,6f,70,ac))) )->frames = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFT",d6,39,ef,3b))) )->frames;
HXLINE( 566)				( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFT",d6,39,ef,3b))) )->frames = oldRight;
HXLINE( 569)				if (::hx::IsNotNull( this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3)) )) {
HXLINE( 571)					::Array< int > oldMiss = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3))) )->frames;
HXLINE( 572)					( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3))) )->frames = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFTmiss",d2,2f,9c,b6))) )->frames;
HXLINE( 573)					( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFTmiss",d2,2f,9c,b6))) )->frames = oldMiss;
            				}
            			}
            		}
            	}
...
void Character_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_580_update)
HXLINE( 581)		if (!(::StringTools_obj::startsWith(this->curCharacter,HX_("bf",c4,55,00,00)))) {
HXLINE( 583)			if (::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("sing",4f,96,53,4c))) {
HXLINE( 585)				 ::Character _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 585)				_hx_tmp->holdTimer = (_hx_tmp->holdTimer + elapsed);
            			}
HXLINE( 588)			Float dadVar = ( (Float)(4) );
HXLINE( 590)			if ((this->curCharacter == HX_("dad",47,36,4c,00))) {
HXLINE( 591)				dadVar = ((Float)6.1);
            			}
HXLINE( 592)			if ((this->holdTimer >= ((::Conductor_obj::stepCrochet * dadVar) * ((Float)0.001)))) {
HXLINE( 594)				::haxe::Log_obj::trace(HX_("dance",33,83,83,d4),::hx::SourceInfo(HX_("source/Character.hx",c9,4f,91,f5),594,HX_("Character",89,bb,a4,e3),HX_("update",09,86,05,87)));
HXLINE( 595)				this->dance();
HXLINE( 596)				this->holdTimer = ( (Float)(0) );
            			}
            		}
HXLINE( 600)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 603)			bool _hx_tmp;
HXDLIN( 603)			if ((this->animation->_curAnim->name == HX_("hairFall",bd,48,d6,cb))) {
HXLINE( 603)				_hx_tmp = this->animation->_curAnim->finished;
            			}
            			else {
...
HXLINE( 607)		this->super::update(elapsed);
            	}


void Character_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_617_dance)
HXDLIN( 617)		if (!(this->debugMode)) {
HXLINE( 619)			::String _hx_switch_0 = this->curCharacter;
            			if (  (_hx_switch_0==HX_("gf",1f,5a,00,00)) ){
...
HXLINE( 633)				goto _hx_goto_21;
            			...
            			if (  (_hx_switch_0==HX_("gf-pixel",98,3e,8c,55)) ){
HXLINE( 654)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 656)					this->danced = !(this->danced);
HXLINE( 658)					if (this->danced) {
HXLINE( 659)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 661)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
...
HXLINE( 664)				goto _hx_goto_21;
            			}
            			/* default */{
HXLINE( 672)				this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
            			}
            			_hx_goto_21:;
            		}
            	}
...
void Character_obj::playAnim(::String AnimName,::hx::Null< bool >  __o_Force,::hx::Null< bool >  __o_Reversed,::hx::Null< int >  __o_Frame){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_678_playAnim)
HXLINE( 679)		this->animation->play(AnimName,Force,Reversed,Frame);
HXLINE( 681)		::cpp::VirtualArray daOffset = ( (::cpp::VirtualArray)(this->animOffsets->get(AnimName)) );
HXLINE( 682)		if (this->animOffsets->exists(AnimName)) {
HXLINE( 684)			this->offset->set(daOffset->__get(0),daOffset->__get(1));
            		}
            		else {
HXLINE( 687)			this->offset->set(0,0);
            		}
HXLINE( 689)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 691)			if ((AnimName == HX_("singLEFT",d6,39,ef,3b))) {
HXLINE( 693)				this->danced = true;
            			}
            			else {
HXLINE( 695)				if ((AnimName == HX_("singRIGHT",0d,6f,70,ac))) {
HXLINE( 697)					this->danced = false;
            				}
            			}
HXLINE( 700)			bool _hx_tmp;
HXDLIN( 700)			if ((AnimName != HX_("singUP",6a,52,21,b9))) {
HXLINE( 700)				_hx_tmp = (AnimName == HX_("singDOWN",31,2a,ad,36));
            			}
            			else {
HXLINE( 700)				_hx_tmp = true;
            			}
HXDLIN( 700)			if (_hx_tmp) {
HXLINE( 702)				this->danced = !(this->danced);
            			}
            		}
            	}
...
void Character_obj::addOffset(::String name,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_709_addOffset)
HXDLIN( 709)		::cpp::VirtualArray v = ::Array_obj< Float >::__new(2)->init(0,x)->init(1,y);
HXDLIN( 709)		this->animOffsets->set(name,v);
            	}
