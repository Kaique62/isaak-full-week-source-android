...
bool FileDialog_obj::browse( ::lime::ui::FileDialogType type,::String filter,::String defaultPath,::String title){
            	HX_STACKFRAME(&_hx_pos_9e2e2667a273619d_35_browse)
HXLINE(  36)		if (::hx::IsNull( type )) {
HXLINE(  36)			type = ::lime::ui::FileDialogType_obj::OPEN_dyn();
            		}
HXLINE( 115)		this->onCancel->dispatch();
...
bool FileDialog_obj::open(::String filter,::String defaultPath,::String title){
            	HX_STACKFRAME(&_hx_pos_9e2e2667a273619d_121_open)
HXLINE( 154)		this->onCancel->dispatch();
