...
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_65_luaAsset,"Paths","luaAsset",0x56a3d678,"Paths.luaAsset","Paths.hx",65,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_70_luaImage,"Paths","luaImage",0xedd38be3,"Paths.luaImage","Paths.hx",70,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_75_txt,"Paths","txt",0x5a3a5910,"Paths.txt","Paths.hx",75,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_80_xml,"Paths","xml",0x5a3d5877,"Paths.xml","Paths.hx",80,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_85_json,"Paths","json",0x9233a388,"Paths.json","Paths.hx",85,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_90_sound,"Paths","sound",0x86f65f6f,"Paths.sound","Paths.hx",90,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_95_soundRandom,"Paths","soundRandom",0x8e79b2d2,"Paths.soundRandom","Paths.hx",95,0x309ea470)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_117_image,"Paths","image",0xc392f1fb,"Paths.image","Paths.hx",117,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_122_font,"Paths","font",0x8f8bbf2f,"Paths.font","Paths.hx",122,0x309ea470)
...
HXDLIN(  60)		::String _hx_tmp = ::Main_obj::path;
HXDLIN(  60)		return (_hx_tmp + ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + key) + HX_(".lua",4a,2a,ba,1e)),HX_("TEXT",ad,94,ba,37),library));
            	}
...
::String Paths_obj::luaAsset(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_65_luaAsset)
HXDLIN(  65)		return ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + key) + HX_(".lua",4a,2a,ba,1e)),HX_("TEXT",ad,94,ba,37),library);
            	}
...
::String Paths_obj::luaImage(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_70_luaImage)
HXDLIN(  70)		::String _hx_tmp = ::Main_obj::path;
HXDLIN(  70)		return (_hx_tmp + ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library));
            	}
...
::String Paths_obj::txt(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_75_txt)
HXDLIN(  75)		return ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + key) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library);
            	}
...
::String Paths_obj::xml(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_80_xml)
HXDLIN(  80)		return ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            	}
...
::String Paths_obj::json(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_85_json)
HXDLIN(  85)		return ::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + key) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library);
            	}
...
::String Paths_obj::sound(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_90_sound)
HXDLIN(  90)		return ::Paths_obj::getPath((((HX_("sounds/",eb,02,a5,b6) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("SOUND",af,c4,ba,fe),library);
            	}
...
::String Paths_obj::soundRandom(::String key,int min,int max,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_95_soundRandom)
HXDLIN(  95)		return ::Paths_obj::sound((key + ::flixel::FlxG_obj::random->_hx_int(min,max,null())),library);
            	}
...
HXLINE( 105)		song = ::StringTools_obj::replace(song,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE( 106)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + song.toLowerCase()) + HX_("/Voices.",1e,f6,e5,90)) + HX_("ogg",4f,94,54,00));
            	}
...
HXLINE( 111)		song = ::StringTools_obj::replace(song,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE( 112)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + song.toLowerCase()) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00));
            	}
...
::String Paths_obj::image(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_117_image)
HXDLIN( 117)		return ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            	}
...
::String Paths_obj::font(::String key){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_122_font)
HXDLIN( 122)		return (HX_("assets/fonts/",37,ff,a5,9c) + key);
            	}
