...
HX_DEFINE_STACK_FRAME(_hx_pos_72f1a114c5fe7f32_181_new,"GhostTapOption","new",0x6c686a7b,"GhostTapOption.new","Options.hx",181,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_72f1a114c5fe7f32_187_press,"GhostTapOption","press",0xd68bea5e,"GhostTapOption.press","Options.hx",187,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_72f1a114c5fe7f32_195_updateDisplay,"GhostTapOption","updateDisplay",0xb7c6f914,"GhostTapOption.updateDisplay","Options.hx",195,0x9d9a0240)

void GhostTapOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_72f1a114c5fe7f32_181_new)
HXLINE( 182)		super::__construct();
HXLINE( 183)		this->description = desc;
            	}
...
bool GhostTapOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_72f1a114c5fe7f32_187_press)
HXLINE( 188)		::flixel::FlxG_obj::save->data->__SetField(HX_("ghost",4f,8f,58,93),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("ghost",4f,8f,58,93),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 189)		this->display = this->updateDisplay();
HXLINE( 190)		return true;
            	}


::String GhostTapOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_72f1a114c5fe7f32_195_updateDisplay)
HXDLIN( 195)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("ghost",4f,8f,58,93),::hx::paccDynamic)) )) {
HXDLIN( 195)			return HX_("Ghost Tapping",44,6c,9f,40);
            		}
            		else {
HXDLIN( 195)			return HX_("No Ghost Tapping",45,a4,10,e0);
            		}
