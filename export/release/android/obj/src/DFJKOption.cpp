...
HX_DEFINE_STACK_FRAME(_hx_pos_c83b011b1ca270a7_117_new,"DFJKOption","new",0xfb5a698a,"DFJKOption.new","Options.hx",117,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_c83b011b1ca270a7_123_press,"DFJKOption","press",0x85470b2d,"DFJKOption.press","Options.hx",123,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_c83b011b1ca270a7_130_updateDisplay,"DFJKOption","updateDisplay",0xd7d600e3,"DFJKOption.updateDisplay","Options.hx",130,0x9d9a0240)

void DFJKOption_obj::__construct( ::Controls controls){
            	HX_STACKFRAME(&_hx_pos_c83b011b1ca270a7_117_new)
...
bool DFJKOption_obj::press(){
            	HX_GC_STACKFRAME(&_hx_pos_c83b011b1ca270a7_123_press)
HXLINE( 124)		 ::OptionsMenu _hx_tmp = ::OptionsMenu_obj::instance;
HXDLIN( 124)		_hx_tmp->openSubState( ::KeyBindMenu_obj::__alloc( HX_CTX ,null()));
HXLINE( 125)		return false;
            	}


::String DFJKOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_c83b011b1ca270a7_130_updateDisplay)
HXDLIN( 130)		return HX_("Key Bindings",6f,44,93,fe);
            	}
