...
HX_DEFINE_STACK_FRAME(_hx_pos_24a6120f5d880dfd_586_new,"WatermarkOption","new",0xd9f8738b,"WatermarkOption.new","Options.hx",586,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_24a6120f5d880dfd_592_press,"WatermarkOption","press",0xcefc576e,"WatermarkOption.press","Options.hx",592,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_24a6120f5d880dfd_601_updateDisplay,"WatermarkOption","updateDisplay",0x9902f624,"WatermarkOption.updateDisplay","Options.hx",601,0x9d9a0240)

void WatermarkOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_24a6120f5d880dfd_586_new)
HXLINE( 587)		super::__construct();
HXLINE( 588)		this->description = desc;
            	}
...
bool WatermarkOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_24a6120f5d880dfd_592_press)
HXLINE( 593)		::Main_obj::watermarks = !(::Main_obj::watermarks);
HXLINE( 594)		::flixel::FlxG_obj::save->data->__SetField(HX_("watermark",a4,af,1e,e0),::Main_obj::watermarks,::hx::paccDynamic);
HXLINE( 595)		this->display = this->updateDisplay();
HXLINE( 596)		return true;
            	}


::String WatermarkOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_24a6120f5d880dfd_601_updateDisplay)
HXDLIN( 601)		::String _hx_tmp;
HXDLIN( 601)		if (::Main_obj::watermarks) {
HXDLIN( 601)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
            		else {
HXDLIN( 601)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
HXDLIN( 601)		return (HX_("Watermarks ",d1,dc,17,0d) + _hx_tmp);
            	}
