...
HXLINE(  82)		this->initialState = ::hx::ClassOf< ::TitleState >();
HXLINE(  85)		this->game =  ::flixel::FlxGame_obj::__alloc( HX_CTX ,this->gameWidth,this->gameHeight,this->initialState,this->zoom,this->framerate,this->framerate,this->skipSplash,this->startFullscreen);
HXLINE(  87)		this->addChild(this->game);
HXLINE(  89)		::String ourSource = HX_("assets/videos/DO NOT DELETE OR GAME WILL CRASH/dontDelete.webm",a4,1f,1a,38);
HXLINE( 101)		::String str1 = HX_("WEBM SHIT",e7,ff,8c,40);
HXLINE( 102)		 ::WebmHandler webmHandle =  ::WebmHandler_obj::__alloc( HX_CTX );
HXLINE( 103)		webmHandle->source(ourSource);
HXLINE( 104)		webmHandle->makePlayer();
HXLINE( 105)		webmHandle->webm->set_name(str1);
HXLINE( 106)		this->addChild(webmHandle->webm);
HXLINE( 107)		::GlobalVideo_obj::setWebm(webmHandle);
HXLINE( 111)		this->fpsCounter =  ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,3,16777215);
HXLINE( 112)		this->addChild(this->fpsCounter);
HXLINE( 113)		this->toggleFPS(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ));
            	}
...
HXDLIN(  29)		path = ::lime::_hx_system::System_obj::get_applicationStorageDirectory();
            	}
{
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_31_boot)
HXDLIN(  31)		watermarks = true;
            	}
}
