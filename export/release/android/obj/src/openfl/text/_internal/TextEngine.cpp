...
HXLINE( 376)			::String _hx_switch_0 = format->font;
            			if (  (_hx_switch_0==HX_("_sans",32,a0,5e,ff)) ){
HXLINE( 417)				fontList = ::Array_obj< ::String >::__new(1)->init(0,(systemFontDirectory + HX_("/DroidSans.ttf",f8,c6,8e,4f)));
HXDLIN( 417)				goto _hx_goto_140;
            			}
            			if (  (_hx_switch_0==HX_("_serif",be,66,15,76)) ){
HXLINE( 422)				goto _hx_goto_140;
            			}
            			if (  (_hx_switch_0==HX_("_typewriter",0c,5e,52,94)) ){
HXLINE( 465)				fontList = ::Array_obj< ::String >::__new(1)->init(0,(systemFontDirectory + HX_("/DroidSansMono.ttf",bb,6c,31,55)));
HXDLIN( 465)				goto _hx_goto_140;
            			}
            			/* default */{
...
HXLINE( 528)		fontList = ::Array_obj< ::String >::__new(2)->init(0,(systemFontDirectory + HX_("/DroidSerif-Regular.ttf",57,b0,ef,46)))->init(1,(systemFontDirectory + HX_("/NotoSerif-Regular.ttf",59,73,f1,28)));
HXLINE( 536)		{
HXLINE( 536)			int _g = 0;
