...
HX_LOCAL_STACK_FRAME(_hx_pos_069fe0fa1a76d977_1348_saveFileDialog_onSelect,"openfl.net.FileReference","saveFileDialog_onSelect",0x20977dab,"openfl.net.FileReference.saveFileDialog_onSelect","openfl/net/FileReference.hx",1348,0x825195e0)
HX_LOCAL_STACK_FRAME(_hx_pos_069fe0fa1a76d977_1373_urlLoader_onComplete,"openfl.net.FileReference","urlLoader_onComplete",0x4ddaf243,"openfl.net.FileReference.urlLoader_onComplete","openfl/net/FileReference.hx",1373,0x825195e0)
...
bool FileReference_obj::browse(::Array< ::Dynamic> typeFilter){
            	HX_STACKFRAME(&_hx_pos_069fe0fa1a76d977_551_browse)
...
void FileReference_obj::save( ::Dynamic data,::String defaultFileName){
            	HX_STACKFRAME(&_hx_pos_069fe0fa1a76d977_1025_save)
...
void FileReference_obj::saveFileDialog_onSelect(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_069fe0fa1a76d977_1348_saveFileDialog_onSelect)
HXDLIN(1348)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("select",fc,1a,33,6a),null(),null()));
            	}
...
void FileReference_obj::urlLoader_onComplete( ::openfl::events::Event event){
            	HX_STACKFRAME(&_hx_pos_069fe0fa1a76d977_1373_urlLoader_onComplete)
HXDLIN(1373)		this->dispatchEvent(event);
            	}
