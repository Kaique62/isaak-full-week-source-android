...
HX_DEFINE_STACK_FRAME(_hx_pos_3fccbae956d84d25_544_new,"AccuracyDOption","new",0xe62cee92,"AccuracyDOption.new","Options.hx",544,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_3fccbae956d84d25_550_press,"AccuracyDOption","press",0xad8ae235,"AccuracyDOption.press","Options.hx",550,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_3fccbae956d84d25_558_updateDisplay,"AccuracyDOption","updateDisplay",0xd1d41feb,"AccuracyDOption.updateDisplay","Options.hx",558,0x9d9a0240)

void AccuracyDOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_3fccbae956d84d25_544_new)
HXLINE( 545)		super::__construct();
HXLINE( 546)		this->description = desc;
            	}
...
bool AccuracyDOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_3fccbae956d84d25_550_press)
HXLINE( 551)		 ::Dynamic _hx_tmp;
HXDLIN( 551)		if (::hx::IsEq( ::flixel::FlxG_obj::save->data->__Field(HX_("accuracyMod",09,b2,8a,86),::hx::paccDynamic),1 )) {
HXLINE( 551)			_hx_tmp = 0;
            		}
            		else {
HXLINE( 551)			_hx_tmp = 1;
            		}
HXDLIN( 551)		::flixel::FlxG_obj::save->data->__SetField(HX_("accuracyMod",09,b2,8a,86),_hx_tmp,::hx::paccDynamic);
HXLINE( 552)		this->display = this->updateDisplay();
HXLINE( 553)		return true;
            	}


::String AccuracyDOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_3fccbae956d84d25_558_updateDisplay)
HXDLIN( 558)		::String _hx_tmp;
HXDLIN( 558)		if (::hx::IsEq( ::flixel::FlxG_obj::save->data->__Field(HX_("accuracyMod",09,b2,8a,86),::hx::paccDynamic),0 )) {
HXDLIN( 558)			_hx_tmp = HX_("Accurate",14,d1,76,d9);
            		}
            		else {
HXDLIN( 558)			_hx_tmp = HX_("Complex",10,8e,c2,50);
            		}
HXDLIN( 558)		return (HX_("Accuracy Mode: ",d0,5b,59,26) + _hx_tmp);
            	}
