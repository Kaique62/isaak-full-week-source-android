...
HX_DEFINE_STACK_FRAME(_hx_pos_025e862e867d5fe9_34_new,"sys.net._Socket.SocketInput","new",0x5fe92abb,"sys.net._Socket.SocketInput.new","D:\\modding stuff\\haxe\\std/cpp/_std/sys/net/Socket.hx",34,0xaa2b54cc)
HX_LOCAL_STACK_FRAME(_hx_pos_025e862e867d5fe9_38_readByte,"sys.net._Socket.SocketInput","readByte",0xee593543,"sys.net._Socket.SocketInput.readByte","D:\\modding stuff\\haxe\\std/cpp/_std/sys/net/Socket.hx",38,0xaa2b54cc)
HX_LOCAL_STACK_FRAME(_hx_pos_025e862e867d5fe9_50_readBytes,"sys.net._Socket.SocketInput","readBytes",0x9fb565d0,"sys.net._Socket.SocketInput.readBytes","D:\\modding stuff\\haxe\\std/cpp/_std/sys/net/Socket.hx",50,0xaa2b54cc)
HX_LOCAL_STACK_FRAME(_hx_pos_025e862e867d5fe9_67_close,"sys.net._Socket.SocketInput","close",0xbbc7fed3,"sys.net._Socket.SocketInput.close","D:\\modding stuff\\haxe\\std/cpp/_std/sys/net/Socket.hx",67,0xaa2b54cc)
namespace sys{
namespace net{
namespace _Socket{

void SocketInput_obj::__construct( ::Dynamic s){
            	HX_STACKFRAME(&_hx_pos_025e862e867d5fe9_34_new)
...
int SocketInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_025e862e867d5fe9_38_readByte)
HXDLIN(  38)		try {
...
int SocketInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_025e862e867d5fe9_50_readBytes)
HXLINE(  51)		int r;
...
void SocketInput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_025e862e867d5fe9_67_close)
