...
HX_DEFINE_STACK_FRAME(_hx_pos_5e79d60792fdc699_35_new,"sys.net.Host","new",0x056496ac,"sys.net.Host.new","D:\\modding stuff\\haxe\\std/cpp/_std/sys/net/Host.hx",35,0x564a25f7)
HX_LOCAL_STACK_FRAME(_hx_pos_8859c6dda491e534_57___init__,"::sys::net::Host_obj","__init__",0x01315e0e,"::sys::net::Host_obj.__init__","D:\\modding stuff\\haxe\\std/cpp/_std/sys/net/Host.hx",57,0x564a25f7)
HX_LOCAL_STACK_FRAME(_hx_pos_5e79d60792fdc699_45_toString,"sys.net.Host","toString",0xe5efb6e0,"sys.net.Host.toString","D:\\modding stuff\\haxe\\std/cpp/_std/sys/net/Host.hx",45,0x564a25f7)
namespace sys{
namespace net{

void Host_obj::__construct(::String name){
            	HX_STACKFRAME(&_hx_pos_5e79d60792fdc699_35_new)
...
void Host_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_8859c6dda491e534_57___init__)
HXDLIN(  57)		_hx_std_socket_init();
            	}


::String Host_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_5e79d60792fdc699_45_toString)
