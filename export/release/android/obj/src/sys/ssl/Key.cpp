...
HX_DEFINE_STACK_FRAME(_hx_pos_2295ee829cedc3d3_34_new,"sys.ssl.Key","new",0xfc27226e,"sys.ssl.Key.new","D:\\modding stuff\\haxe\\std/cpp/_std/sys/ssl/Key.hx",34,0x0782786f)
HX_LOCAL_STACK_FRAME(_hx_pos_59b9e3ca97ddc7b1_55___init__,"::sys::ssl::Key_obj","__init__",0x25088cc6,"::sys::ssl::Key_obj.__init__","D:\\modding stuff\\haxe\\std/cpp/_std/sys/ssl/Key.hx",55,0x0782786f)
namespace sys{
namespace ssl{

void Key_obj::__construct( ::Dynamic k){
            	HX_STACKFRAME(&_hx_pos_2295ee829cedc3d3_34_new)
...
void Key_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_59b9e3ca97ddc7b1_55___init__)
