...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_316_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",316,0x0d86f62d)
...
HXLINE( 320)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 319)		this->week = 0;
HXLINE( 318)		this->songName = HX_("",00,00,00,00);
HXLINE( 324)		this->songName = song;
HXLINE( 325)		this->week = week;
HXLINE( 326)		this->songCharacter = songCharacter;
            	}
