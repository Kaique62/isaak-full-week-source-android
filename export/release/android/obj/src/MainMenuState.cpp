...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_206_update,"MainMenuState","update",0x766d017e,"MainMenuState.update","MainMenuState.hx",206,0x0e5db805)
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_224_goToState,"MainMenuState","goToState",0xcf6f00f9,"MainMenuState.goToState","MainMenuState.hx",224,0x0e5db805)
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_254_changeItem,"MainMenuState","changeItem",0xf62bd498,"MainMenuState.changeItem","MainMenuState.hx",254,0x0e5db805)
...
HXLINE(  65)		bg1->scrollFactor->set_y(( (Float)(0) ));
...
HXLINE(  77)		this->magenta->scrollFactor->set_y(( (Float)(0) ));
...
HXLINE(  93)				 ::flixel::FlxSprite menuItem =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)1.6)),null());
...
HXLINE( 103)				if (::MainMenuState_obj::firstStart) {
...
HXLINE( 106)						::MainMenuState_obj::finishedFunnyMove = true;
HXLINE( 107)						_gthis->changeItem(null());
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE( 104)					::flixel::tweens::FlxTween_obj::tween(menuItem, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 110)					menuItem->set_y(( (Float)((60 + (i * 160))) ));
            				}
            			}
            		}
HXLINE( 113)		::MainMenuState_obj::firstStart = false;
HXLINE( 115)		::flixel::FlxG_obj::camera->follow(this->camFollow,null(),(((Float)0.60) * (( (Float)(60) ) / ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic)) ))));
HXLINE( 117)		::String versionShit;
HXDLIN( 117)		if (::Main_obj::watermarks) {
HXLINE( 117)			versionShit = ((HX_(" FNF - ",55,b8,48,47) + ::MainMenuState_obj::kadeEngineVer) + HX_(" Kade Engine",0b,2a,4a,30));
            		}
            		else {
HXLINE( 117)			versionShit = HX_("",00,00,00,00);
            		}
HXDLIN( 117)		 ::flixel::text::FlxText versionShit1 =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,5,(::flixel::FlxG_obj::height - 18),0,(::MainMenuState_obj::gameVer + versionShit),12,null());
HXLINE( 118)		versionShit1->scrollFactor->set(null(),null());
HXLINE( 119)		versionShit1->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 120)		this->add(versionShit1);
HXLINE( 125)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("dfjk",c3,18,67,42),::hx::paccDynamic)) )) {
HXLINE( 126)			::PlayerSettings_obj::player1->controls->setKeyboardScheme(::KeyboardScheme_obj::Solo_dyn(),true);
            		}
            		else {
HXLINE( 128)			::PlayerSettings_obj::player1->controls->setKeyboardScheme(::KeyboardScheme_obj::Duo(true),true);
            		}
HXLINE( 130)		this->changeItem(null());
HXLINE( 133)		this->addVirtualPad(::ui::FlxDPadMode_obj::UP_DOWN_dyn(),::ui::FlxActionMode_obj::A_B_dyn());
...
HXLINE( 219)			spr->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_142_update)
HXDLIN( 142)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 143)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.8))) {
HXLINE( 145)			 ::flixel::_hx_system::FlxSound fh = ::flixel::FlxG_obj::sound->music;
HXDLIN( 145)			fh->set_volume((fh->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
HXLINE( 148)		if (!(this->selectedSomethin)) {
HXLINE( 150)			if (::PlayerSettings_obj::player1->controls->_upP->check()) {
...
HXLINE( 162)			if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 164)				 ::flixel::FlxState nextState =  ::TitleState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 169)				if ((this->optionShit->__get(this->curSelected) != HX_("donate",6f,f1,29,2e))) {
...
HXLINE( 195)							if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )) {
...
HXLINE( 199)									_gthis->goToState();
            								}
            								HX_END_LOCAL_FUNC1((void))

HXLINE( 197)								::flixel::effects::FlxFlicker_obj::flicker(spr,1,((Float)0.06),false,false, ::Dynamic(new _hx_Closure_1(_gthis)),null());
            							}
            							else {
            								HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_2, ::MainMenuState,_gthis) HXARGC(1)
            								void _hx_run( ::flixel::util::FlxTimer tmr){
            									HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_206_update)
HXLINE( 206)									_gthis->goToState();
            								}
            								HX_END_LOCAL_FUNC1((void))

HXLINE( 204)								 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(1, ::Dynamic(new _hx_Closure_2(_gthis)),null());
            							}
            						}
            					}
            					HX_END_LOCAL_FUNC1((void))
...
HXDLIN( 176)					_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),null(),null(),null(),null(),null());
HXLINE( 178)					if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )) {
HXLINE( 179)						::flixel::effects::FlxFlicker_obj::flicker(this->magenta,((Float)1.1),((Float)0.15),false,null(),null(),null());
            					}
HXLINE( 181)					this->menuItems->forEach( ::Dynamic(new _hx_Closure_3(_gthis)),null());
            				}
            			}
            		}
HXLINE( 215)		this->super::update(elapsed);
HXLINE( 217)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_4()),null());
            	}


void MainMenuState_obj::goToState(){
            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_224_goToState)
HXLINE( 225)		::String daChoice = this->optionShit->__get(this->curSelected);
HXLINE( 227)		::String _hx_switch_0 = daChoice;
            		if (  (_hx_switch_0==HX_("freeplay",a0,90,86,22)) ){
HXLINE( 233)			{
HXLINE( 233)				 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 233)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 233)					::flixel::FlxG_obj::game->_requestedState = nextState;
            				}
            			}
HXLINE( 235)			::haxe::Log_obj::trace(HX_("Freeplay Menu Selected",9c,6d,5a,ca),::hx::SourceInfo(HX_("source/MainMenuState.hx",f9,ee,86,cf),235,HX_("MainMenuState",59,88,5e,20),HX_("goToState",4e,a5,e1,c9)));
HXLINE( 232)			goto _hx_goto_11;
            		}
            		if (  (_hx_switch_0==HX_("options",5e,33,fe,df)) ){
HXLINE( 238)			 ::flixel::FlxState nextState =  ::OptionsMenu_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 230)			{
HXLINE( 230)				 ::flixel::FlxState nextState =  ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 230)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 230)					::flixel::FlxG_obj::game->_requestedState = nextState;
            				}
            			}
HXLINE( 231)			::haxe::Log_obj::trace(HX_("Story Menu Selected",71,ff,9b,4a),::hx::SourceInfo(HX_("source/MainMenuState.hx",f9,ee,86,cf),231,HX_("MainMenuState",59,88,5e,20),HX_("goToState",4e,a5,e1,c9)));
...
void MainMenuState_obj::changeItem(::hx::Null< int >  __o_huh){
            		HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::MainMenuState,_gthis) HXARGC(1)
            		void _hx_run( ::flixel::FlxSprite spr){
            			HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_254_changeItem)
HXLINE( 255)			spr->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 257)			bool _hx_tmp;
HXDLIN( 257)			if ((spr->ID == _gthis->curSelected)) {
HXLINE( 257)				_hx_tmp = ::MainMenuState_obj::finishedFunnyMove;
            			}
            			else {
HXLINE( 257)				_hx_tmp = false;
            			}
HXDLIN( 257)			if (_hx_tmp) {
HXLINE( 259)				spr->animation->play(HX_("selected",5b,2a,6d,b1),null(),null(),null());
HXLINE( 260)				 ::flixel::FlxObject _gthis1 = _gthis->camFollow;
HXDLIN( 260)				Float _hx_tmp = spr->getGraphicMidpoint(null())->x;
HXDLIN( 260)				_gthis1->setPosition(_hx_tmp,spr->getGraphicMidpoint(null())->y);
            			}
...
HXDLIN( 243)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 244)		if (::MainMenuState_obj::finishedFunnyMove) {
HXLINE( 246)			 ::MainMenuState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 246)			_hx_tmp->curSelected = (_hx_tmp->curSelected + huh);
HXLINE( 248)			if ((this->curSelected >= this->menuItems->length)) {
HXLINE( 249)				this->curSelected = 0;
            			}
HXLINE( 250)			if ((this->curSelected < 0)) {
HXLINE( 251)				this->curSelected = (this->menuItems->length - 1);
            			}
            		}
HXLINE( 253)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_0(_gthis)),null());
            	}
