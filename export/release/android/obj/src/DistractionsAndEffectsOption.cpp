...
HX_DEFINE_STACK_FRAME(_hx_pos_bee9e2404fe2fe77_242_new,"DistractionsAndEffectsOption","new",0x025cdf63,"DistractionsAndEffectsOption.new","Options.hx",242,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_bee9e2404fe2fe77_247_press,"DistractionsAndEffectsOption","press",0x2a356946,"DistractionsAndEffectsOption.press","Options.hx",247,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_bee9e2404fe2fe77_255_updateDisplay,"DistractionsAndEffectsOption","updateDisplay",0x58e59ffc,"DistractionsAndEffectsOption.updateDisplay","Options.hx",255,0x9d9a0240)

void DistractionsAndEffectsOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_bee9e2404fe2fe77_242_new)
HXLINE( 243)		super::__construct();
HXLINE( 244)		this->description = desc;
            	}
...
bool DistractionsAndEffectsOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_bee9e2404fe2fe77_247_press)
HXLINE( 248)		::flixel::FlxG_obj::save->data->__SetField(HX_("distractions",31,13,7d,60),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 249)		this->display = this->updateDisplay();
HXLINE( 250)		return true;
            	}


::String DistractionsAndEffectsOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_bee9e2404fe2fe77_255_updateDisplay)
HXDLIN( 255)		::String _hx_tmp;
HXDLIN( 255)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) ))) {
HXDLIN( 255)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 255)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 255)		return (HX_("Distractions ",af,07,e4,54) + _hx_tmp);
            	}
