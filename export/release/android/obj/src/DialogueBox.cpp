...
HXLINE( 181)		bool justTouched = false;
HXLINE( 183)		{
HXLINE( 183)			int _g = 0;
HXDLIN( 183)			::Array< ::Dynamic> _g1 = ::flixel::FlxG_obj::touches->list;
HXDLIN( 183)			while((_g < _g1->length)){
HXLINE( 183)				 ::flixel::input::touch::FlxTouch touch = _g1->__get(_g).StaticCast<  ::flixel::input::touch::FlxTouch >();
HXDLIN( 183)				_g = (_g + 1);
HXLINE( 185)				justTouched = false;
HXLINE( 187)				if ((touch->input->current == 2)) {
HXLINE( 188)					justTouched = true;
            				}
            			}
            		}
HXLINE( 193)		bool _hx_tmp1;
HXDLIN( 193)		if (!(( ( ::flixel::input::FlxBaseKeyList)(::flixel::FlxG_obj::keys->justPressed) )->get_ANY())) {
HXLINE( 193)			if (justTouched) {
...
HXLINE( 199)				_hx_tmp1 = ::hx::IsNotNull( this->dialogueList->__get(0) );
            			}
            			else {
