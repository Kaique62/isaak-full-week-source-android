...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_56_update,"GameOverSubstate","update",0x4cd2a460,"GameOverSubstate.update","GameOverSubstate.hx",56,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_93_beatHit,"GameOverSubstate","beatHit",0xc1b25846,"GameOverSubstate.beatHit","GameOverSubstate.hx",93,0x01fbc1e7)
...
HXLINE(  51)		this->addVirtualPad(::ui::FlxDPadMode_obj::NONE_dyn(),::ui::FlxActionMode_obj::A_B_dyn());
            	}
...
void GameOverSubstate_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_56_update)
HXLINE(  57)		this->super::update(elapsed);
HXLINE(  59)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE(  61)			this->endBullshit();
            		}
HXLINE(  64)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE(  66)			{
HXLINE(  66)				 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN(  66)				_this->cleanup(_this->autoDestroy,true);
            			}
HXLINE(  68)			if (::PlayState_obj::isStoryMode) {
HXLINE(  69)				 ::flixel::FlxState nextState =  ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN(  69)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE(  69)					::flixel::FlxG_obj::game->_requestedState = nextState;
            				}
            			}
            			else {
HXLINE(  71)				 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN(  71)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE(  71)					::flixel::FlxG_obj::game->_requestedState = nextState;
            				}
            			}
HXLINE(  72)			::PlayState_obj::loadRep = false;
            		}
HXLINE(  75)		bool _hx_tmp;
HXDLIN(  75)		if ((this->bf->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14))) {
HXLINE(  75)			_hx_tmp = (this->bf->animation->_curAnim->curFrame == 12);
            		}
            		else {
HXLINE(  75)			_hx_tmp = false;
            		}
HXDLIN(  75)		if (_hx_tmp) {
HXLINE(  77)			::flixel::FlxG_obj::camera->follow(this->camFollow,::flixel::FlxCameraFollowStyle_obj::LOCKON_dyn(),((Float)0.01));
            		}
HXLINE(  80)		bool _hx_tmp1;
HXDLIN(  80)		if ((this->bf->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14))) {
HXLINE(  80)			_hx_tmp1 = this->bf->animation->_curAnim->finished;
            		}
            		else {
...
HXDLIN(  82)			_hx_tmp->playMusic(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (HX_("gameOver",66,92,de,b5) + this->stageSuffix)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null());
            		}
HXLINE(  85)		if (::hx::IsNotNull( ::flixel::FlxG_obj::sound->music->_channel )) {
...
void GameOverSubstate_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_b2ae8d30512793fc_93_beatHit)
HXDLIN(  93)		this->super::beatHit();
            	}


void GameOverSubstate_obj::endBullshit(){
            	HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_102_endBullshit)
HXDLIN( 102)		if (!(this->isEnding)) {
...
HXLINE( 104)			this->isEnding = true;
HXLINE( 105)			this->bf->playAnim(HX_("deathConfirm",2c,44,2b,12),true,null(),null());
HXLINE( 106)			{
...
HXDLIN( 107)			_hx_tmp->play(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (HX_("gameOverEnd",15,2d,a9,8d) + this->stageSuffix)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null(),null(),null());
