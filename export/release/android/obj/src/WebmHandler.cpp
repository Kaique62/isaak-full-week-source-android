...
HXLINE(  31)		this->io =  ::webm::WebmIoFile_obj::__alloc( HX_CTX ,::Asset2File_obj::getPath(this->vidPath,null()));
...
HXLINE(  52)		this->io =  ::webm::WebmIoFile_obj::__alloc( HX_CTX ,::Asset2File_obj::getPath(this->vidPath,null()));
