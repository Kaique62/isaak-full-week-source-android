...
HX_DECLARE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_316_new)
...
{
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_316_new)
HXLINE( 320)		( ( ::SongMetadata)(__this) )->songCharacter = HX_("",00,00,00,00);
HXLINE( 319)		( ( ::SongMetadata)(__this) )->week = 0;
HXLINE( 318)		( ( ::SongMetadata)(__this) )->songName = HX_("",00,00,00,00);
HXLINE( 324)		( ( ::SongMetadata)(__this) )->songName = song;
HXLINE( 325)		( ( ::SongMetadata)(__this) )->week = week;
HXLINE( 326)		( ( ::SongMetadata)(__this) )->songCharacter = songCharacter;
            	}
