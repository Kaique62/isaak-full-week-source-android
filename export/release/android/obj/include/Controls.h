...
class HXCPP_CLASS_ATTRIBUTES Controls_obj : public  ::flixel::input::actions::FlxActionSet_obj
{
	...
	public:
		...
		void addbutton( ::flixel::input::actions::FlxActionDigital action, ::flixel::ui::FlxButton button,int state);
		::Dynamic addbutton_dyn();

		void setHitBox( ::ui::Hitbox hitbox);
		::Dynamic setHitBox_dyn();

		void setVirtualPad( ::ui::FlxVirtualPad virtualPad, ::ui::FlxDPadMode DPad, ::ui::FlxActionMode Action);
		::Dynamic setVirtualPad_dyn();

		void removeFlxInput( ::Dynamic Tinputs);
		::Dynamic removeFlxInput_dyn();

		void addAndroidBack();
		::Dynamic addAndroidBack_dyn();
