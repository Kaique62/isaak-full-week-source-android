...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{
            var daStrangePath = Paths.getSparrowAtlas('characters/isaacshifting', 'shared');
            isaakPreload = new FlxSprite(0,0);
            isaakPreload.frames = daStrangePath;
            isaakPreload.visible = false;
            isaakPreload.animation.addByPrefix('idle', 'ShiftingIdle', 24);
			isaakPreload.animation.addByPrefix('singUP', 'ShiftingUp', 24);
			isaakPreload.animation.addByPrefix('singRIGHT', 'ShiftingRight', 24);
			isaakPreload.animation.addByPrefix('singDOWN', 'ShiftingDown', 24);
			isaakPreload.animation.addByPrefix('singLEFT', 'ShiftingLeft', 24);
			isaakPreload.animation.play('idle');
			add(isaakPreload);
        }
